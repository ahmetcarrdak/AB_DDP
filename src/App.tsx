...
const CompanySettingsScreen = React.lazy(() => import("./Screens/CompanySettingsScreen"));

// Lazy load Create Screens
const MaterialAddScreen = React.lazy(() => import("./Screens/Create/MaterialAddScreen"));
const WorkCreateScreen = React.lazy(() => import("./Screens/Create/WorkCreateScreen"));
const OrderCreateScreen = React.lazy(() => import("./Screens/Create/OrderCreateScreen"));
const PersonCreate = React.lazy(() => import("./Screens/Create/PersonCreateScreen"));

// Lazy load Update Screens
const MaterialUpdateById = React.lazy(() => import("./Screens/Update/MaterialUpdateById"));
const MaterialUpdate = React.lazy(() => import("./Screens/Update/MaterialUpdate"));
const WorkUpdateById = React.lazy(() => import("./Screens/Update/WorkUpdateById"));
const WorkUpdate = React.lazy(() => import("./Screens/Update/WorkUpdate"));
const OrderUpdateById = React.lazy(() => import("./Screens/Update/OrderUpdateById"));
const OrderUpdate = React.lazy(() => import("./Screens/Update/OrderUpdate"));
const PersonUpdateById = React.lazy(() => import("./Screens/Update/PersonUpdateById"));
            ...
            <Suspense fallback={<LoadingSpinner />}>
                ...
                <div className="body">
                    <Routes>
                        ...
                        <Route path="/store-update-material/:id" element={<MaterialUpdateById />} />
