...
const PersonScreen = memo(() => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                const response = await axios.get('http://localhost:5262/api/Person/all');
                                                ...
                                                {editMode ? (
                                                    <form className="table-form">
                                                        ...
                                                        <div className="table-form-group">
                                                            ...
                                                            <div className="table-form-row">
                                                                ...
                                                                <div className="table-form-col">
                                                                    <label className="table-form-label">Soyad:</label>
                                                                    <input
                                                                        type="text"
                                                                        className="table-form-input"
                                                                        value={row.lastName}
                                                                ...
                                                                <div className="table-form-col">
                                                                    <label className="table-form-label">TC Kimlik No:</label>
                                                                    <input
                                                                        type="text"
                                                                        className="table-form-input"
                                                        ...
                                                        <div className="table-form-group">
                                                            ...
                                                            <div className="table-form-row">
                                                                <div className="table-form-col">
                                                                    <label className="table-form-label">Departman:</label>
                                                                    <input
                                                                        type="text"
                                                                        className="table-form-input"
                                                                ...
                                                                <div className="table-form-col">
                                                                    <label className="table-form-label">Pozisyon:</label>
                                                                    <input
                                                                        type="text"
                                                                        className="table-form-input"
                                                                        value={row.position}
                                                                ...
                                                                <div className="table-form-col">
                                                                    <label className="table-form-label">Maaş:</label>
                                                                    <input
                                                                        type="number"
                                                                        className="table-form-input"
                                                                        value={row.salary}
                                                        ...
                                                        <div className="table-form-group">
                                                            ...
                                                            <div className="table-form-row">
                                                                <div className="table-form-col">
                                                                    <label className="table-form-label">Kan Grubu:</label>
                                                                    <input
                                                                        type="text"
                                                                        className="table-form-input"
                                                                        value={row.bloodType}
                                                                ...
                                                                <div className="table-form-col">
                                                                    <label className="table-form-label">Eğitim Seviyesi:</label>
                                                                    <input
                                                                        type="text"
                                                                        className="table-form-input"
                                                                ...
                                                                <div className="table-form-col">
                                                                    <label className="table-form-label">Vardiya Planı:</label>
                                                                    <input
                                                                        type="text"
                                                                        className="table-form-input"
                                                    ...
                                                    <div className={"table-row-detail"}>
                                                        <div className="table-row-detail-item">
                                                            ...
                                                            <div className={`dropdown ${activeDropdown === 'personal' ? 'active' : ''}`}>
                                                                <div className="dropdown-title" onClick={() => toggleDropdown('personal')}>
                                                                    <FaInfoCircle/>
                                                                    <span>Kişisel Bilgiler</span>
                                                                    <IoIosArrowForward/>
                                                                </div>
                                                                <div className={`dropdown-body ${activeDropdown === 'personal' ? 'active' : ''}`}>
                                                            ...
                                                            <div className={`dropdown ${activeDropdown === 'contact' ? 'active' : ''}`}>
                                                                <div className="dropdown-title" onClick={() => toggleDropdown('contact')}>
                                                                    <FaInfoCircle/>
                                                                    <span>İletişim Bilgileri</span>
                                                                    <IoIosArrowForward/>
                                                                </div>
                                                                <div className={`dropdown-body ${activeDropdown === 'contact' ? 'active' : ''}`}>
                                                                    <div className="dropdown-item">
                                                            ...
                                                            <div className={`dropdown ${activeDropdown === 'work' ? 'active' : ''}`}>
                                                                <div className="dropdown-title" onClick={() => toggleDropdown('work')}>
                                                                    <FaInfoCircle/>
                                                                    <span>İş Bilgileri</span>
                                                                    <IoIosArrowForward/>
                                                                </div>
                                                                <div className={`dropdown-body ${activeDropdown === 'work' ? 'active' : ''}`}>
                                                                    <div className="dropdown-item">
                                                                        <span style={{fontWeight: "bold"}}>Departman:</span>
                                                                        {row.department}
                                                                    </div>
                                                                    <div className="dropdown-item">
                                                                        <span style={{fontWeight: "bold"}}>Pozisyon:</span>
                                                                        {row.position}
                                                                    </div>
                                                                    <div className="dropdown-item">
                                                                        <span style={{fontWeight: "bold"}}>Maaş:</span>
                                                                        {row.salary}
                                                                    </div>
                                                                </div>
                                                            </div>

                                                            <div className={`dropdown ${activeDropdown === 'other' ? 'active' : ''}`}>
                                                                <div className="dropdown-title" onClick={() => toggleDropdown('other')}>
                                                                    <FaInfoCircle/>
                                                                    <span>Diğer Bilgiler</span>
                                                                    <IoIosArrowForward/>
                                                                </div>
                                                                <div className={`dropdown-body ${activeDropdown === 'other' ? 'active' : ''}`}>
                                                                    <div className="dropdown-item">
