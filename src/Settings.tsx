...
export const apiUrl = {
  ...
  qualityControl: `${domain}QualityControlRecord/GetAll`,
  qualityControlById: `${domain}QualityControlRecord`,
  createQualityControl: `${domain}QualityControlRecord/Create`,
  qualityControlUpdate: `${domain}QualityControlRecord/Update`,

  machine: `${domain}Machine`,
  machineFault5: `${domain}MachineFault/TotalFault5`,
  machineLatestFault: `${domain}MachineFault/latest-faults`,
  machineFault: `${domain}MachineFault`,

  maintenanceRecord: `${domain}MaintenanceRecord`,
};
